...
@click.option(
    "--dry-run", is_flag=True, help="Simulate operations without actually moving files"
)
@click.option(
    "--log-file",
    type=str,
...
@click.option("--clean-duplicates", is_flag=True, help="Also remove duplicate files")
@click.option(
    "--keep",
    type=click.Choice(["newest", "oldest", "shortest"]),
    default="newest",
